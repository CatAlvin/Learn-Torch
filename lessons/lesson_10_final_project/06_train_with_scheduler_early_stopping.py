...
def save_training_curves(
    ...
    loss_path = output_dir / "lesson_10_scheduler_early_stopping_loss.png"
    acc_path = output_dir / "lesson_10_scheduler_early_stopping_accuracy.png"
    lr_path = output_dir / "lesson_10_scheduler_learning_rate.png"
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("Loss with Scheduler and Early Stopping")
    plt.legend()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title("Accuracy with Scheduler and Early Stopping")
    plt.legend()
...
def main():
    ...
    section("4. Train with scheduler and early stopping")
    ...
    best_model_path = (
        model_dir / "lesson_10_scheduler_early_stopping_best.pth"
    )
